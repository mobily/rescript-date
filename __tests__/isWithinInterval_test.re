...
describe("isWithinInterval", () => {
  ...
  test(
    "returns true if the given date has same time as the left boundary of the interval",
    () => {
      let date = makeWithYMD(~year=2018., ~month=0., ~date=5., ());
  ...
  test(
    "returns true if the given date has same time as the right boundary of the interval",
    () => {
  ...
  test(
    "returns true if the given date and the both boundaries are the same", () => {
    let date = makeWithYMD(~year=2018., ~month=0., ~date=10., ());
    let interval =
      ReDate.{
