...
describe("isSameSecond", () => {
  ...
  test("returns true if the given dates have the same second", () => {
    ...
    let sndDate = makeWithYMDHMS(~year=2018., ~month=0., ~date=1., ~hours=16., ~minutes=50., ~seconds=10., ());
  ...
  test("returns false if the given dates have different seconds", () => {
    ...
    let sndDate = makeWithYMDHMS(~year=2018., ~month=0., ~date=1., ~hours=23., ~minutes=59., ~seconds=58., ());
